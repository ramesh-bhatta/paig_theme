        ...
        <div class="col-md-4">
            ...
            <div class="sidebar-textbox">
                <ul class="contact-details">
                    ...
                    <li><i class="im im-icon-Phone-2"></i> <strong>Phone:</strong> <span><a href="<?php echo getCustomThemeValue("phone_number1"); ?>"><?php echo getCustomThemeValue("phone_number1"); ?></a></span>
                    </li>
                    <li><i class="im im-icon-Envelope"></i> <strong>Email:</strong> <span><a href="<?php echo getCustomThemeValue("email_address"); ?>"><?php echo getCustomThemeValue("email_address"); ?></a></span>
                    </li>
                </ul>
            </div>
