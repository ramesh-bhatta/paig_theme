		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="blog-post">
					...
					<a href="blog-post.html" class="post-img">
						<img src="<?php echo bloginfo('template_directory'); ?>/images/blog-post-01.jpg" alt="">
					</a>
			...
			<div class="col-md-4">
				...
				<div class="blog-post">
					...
					<!-- Img -->
					<a href="blog-post.html" class="post-img">
						<img src="<?php echo bloginfo('template_directory'); ?>/images/blog-post-02.jpg" alt="">
					</a>
			...
			<div class="col-md-4">
				...
				<div class="blog-post">
					...
					<!-- Img -->
					<a href="blog-post.html" class="post-img">
						<img src="<?php echo bloginfo('template_directory'); ?>/images/blog-post-03.jpg" alt="">
					</a>
